package com.bctools.auth.controller;
...
import com.bctools.auth.component.PermissionComponent;
import com.bctools.auth.component.SmsEmailComponent;
import com.bctools.auth.component.UserInfoComponent;
import com.bctools.auth.entity.*;
import com.bctools.auth.login.WxLoginHandler;
import com.bctools.auth.login.dto.RegisterDto;
import com.bctools.auth.service.*;
import com.bctools.auth.vo.ResetPasswordDto;
import com.bctools.common.entity.dto.UserDto;
import com.bctools.common.entity.po.TreePo;
import com.bctools.common.exception.BusinessException;
import com.bctools.common.utils.*;
//import com.bctools.design.use.api.AppApi;
...
//        List treeList = appApi.getMenuTree(isAdmin).getData();
//        if (ObjectNull.isNotNull(treeList)) {
//            permission.addAll(treeList);
//        }
    ...
    public R<List<TreePo>> search(@PathVariable String appKey, @PathVariable String search) {
        ...
        //调用API获取应用菜单
//        R<List> menu = appApi.getMenu(isAdmin, search);
//        添加应用菜单
//        menus.addAll(menu.getData());
        return R.ok(menus);
    }
