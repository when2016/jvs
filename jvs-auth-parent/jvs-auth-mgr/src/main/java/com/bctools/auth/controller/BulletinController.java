...
import com.bctools.auth.entity.enums.BulletinPublishEnum;
...
public class BulletinController {
    ...
    @GetMapping("/{id}")
    public R<Bulletin> detail(@PathVariable String id) {
    ...
    public R deploy(@PathVariable String id) {
    ...
    public R unload(@PathVariable String id) {
        Bulletin jvsApp = service.getById(id);
