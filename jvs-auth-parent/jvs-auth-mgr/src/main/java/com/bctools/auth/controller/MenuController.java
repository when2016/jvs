...
import com.bctools.auth.entity.Apply;
import com.bctools.auth.entity.Menu;
import com.bctools.auth.entity.Role;
import com.bctools.auth.entity.RolePermission;
import com.bctools.auth.entity.enums.RolePermissionEnum;
...
public class MenuController {
    ...
    private void handleLayer(Menu menu) {
        ...
        Assert.notNull(parentId, "父级菜单不存在");
