package com.bctools.common.utils;
...
public class PinyinUtils {
     ...
     * 汉字对应ascii范围
     */
    private static final int[] PINYIN_VALUE = new int[]{-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032, -20026, -20002, -19990, -19986, -19982,
    ...
    private static final String[] PINYIN_STR = new String[]{"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian", "biao", "bie", "bin", "bing", "bo", "bu",
    ...
    public static String getCameCasePinYin(String name) {
        ...
        return IntStream.range(0, name.length()).mapToObj(i -> StrUtil.upperFirst(PinyinUtils.getPinYin(CharUtil.toString(name.charAt(i))))).collect(Collectors.joining());
    }
    //------------------------------------------------------------------------------------------------------- Private method end
}
