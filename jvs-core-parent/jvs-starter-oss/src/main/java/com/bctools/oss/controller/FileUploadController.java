package com.bctools.oss.controller;
...
import com.bctools.oss.dto.Etag;
import com.bctools.oss.dto.FileLinkDto;
import com.bctools.oss.dto.FileNameDto;
...
public class FileUploadController {
    ...
    public R<Page<OssFile>> list(Page<OssFile> page,
        ...
        fileDataInterface.page(page, fileName, fileType, startTime, endTime, label);
        return R.ok(page);
    }
    ...
    public R<byte[]> bytes(@PathVariable("bucketName") String bucketName, @RequestParam("fileName") String fileName) {
        return R.ok(IoUtil.readBytes(fileUploadComponent.getObject(bucketName, fileName)));
    }
