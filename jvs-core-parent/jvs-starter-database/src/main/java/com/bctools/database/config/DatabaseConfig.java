...
import com.bctools.database.controller.TenantDynamicDatasource;
import com.bctools.database.getter.DefaultDataSourceGetter;
import com.bctools.database.getter.DefaultTableFieldGetter;
import com.bctools.database.getter.IDataSourceGetter;
import com.bctools.database.getter.ITableFieldGetter;
import com.bctools.database.init.DataSourceInit;
...
public class DatabaseConfig {
     ...
     * 详情见{@link com.bctools.dynamic.config}
     */
    @Bean
    @ConditionalOnMissingBean
    @ConditionalOnMissingClass("com.bctools.dynamic.config.DynamicDataConfig")
