...
import com.jvs.database.interceptor.datascope.DataScopeInterceptor;
import com.jvs.database.interceptor.datascope.DataSourceExpressionHandlerImpl;
import com.jvs.database.interceptor.datascope.IDataSourceExpressionHandler;
import com.jvs.database.interceptor.other.CustomOthersInterceptor;
import com.jvs.database.interceptor.performance.SQLPerformanceInterceptor;
import com.jvs.database.interceptor.tenant.JvsTenantHandler;
import com.jvs.database.interceptor.tenant.JvsTenantLineInnerInterceptor;
import com.jvs.database.property.SqlProperties;
import com.jvs.database.util.DatabaseUtils;
import com.jvs.database.util.TenantDynamicDatasourceUtil;
...
@MapperScan(basePackages = {"com.jvs.**.mapper"})
