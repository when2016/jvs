package com.bctools.oauth2.config;
...
import com.bctools.database.interceptor.datascope.DataScopeContextHolder;
...
public class JvsUserAuthenticationConverter extends DefaultUserAuthenticationConverter {
    ...
    private DataScopeDto getMatchedDataScope(List<DataScopeDto> dataScopeList) {
        ...
        // 此处的路径匹配度已经过排序 {@link com.bctools.auth.service.impl.DataRoleServiceImpl#queryUserPermission}
