//package com.bctools.document.aop;
//
...
//import com.bctools.upms.core.utils.UserCurrentUtils;
...
//
//    @Pointcut("execution(* com.bctools.document.controller.DcLibraryController.*(..)) &&( @annotation(org.springframework.web.bind.annotation.PostMapping)" +
