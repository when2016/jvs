...
//import com.jvs.upms.core.utils.UserCurrentUtils;
...
//
//    @Pointcut("execution(* com.jvs.document.controller.DcLibraryController.*(..)) &&( @annotation(org.springframework.web.bind.annotation.PostMapping)" +
